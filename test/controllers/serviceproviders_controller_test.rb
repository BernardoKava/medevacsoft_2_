...
class ServiceprovidersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create serviceprovider" do
    assert_difference('Serviceprovider.count') do
      post serviceproviders_url, params: { serviceprovider: { address: @serviceprovider.address, contactperson: @serviceprovider.contactperson, email: @serviceprovider.email, name: @serviceprovider.name, phone: @serviceprovider.phone, services: @serviceprovider.services } }
    end
  ...
  test "should update serviceprovider" do
    patch serviceprovider_url(@serviceprovider), params: { serviceprovider: { address: @serviceprovider.address, contactperson: @serviceprovider.contactperson, email: @serviceprovider.email, name: @serviceprovider.name, phone: @serviceprovider.phone, services: @serviceprovider.services } }
