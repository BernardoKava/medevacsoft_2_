...
class InsurersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create insurer" do
    assert_difference('Insurer.count') do
      post insurers_url, params: { insurer: { address: @insurer.address, companyalias: @insurer.companyalias, contactperson: @insurer.contactperson, email: @insurer.email, entityactive: @insurer.entityactive, name: @insurer.name, phone: @insurer.phone } }
    end
  ...
  test "should update insurer" do
    patch insurer_url(@insurer), params: { insurer: { address: @insurer.address, companyalias: @insurer.companyalias, contactperson: @insurer.contactperson, email: @insurer.email, entityactive: @insurer.entityactive, name: @insurer.name, phone: @insurer.phone } }
